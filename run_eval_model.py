...
from run_ec57_utils import run_ec57, run_portal


def portal_run():
    DB_PATH = '/mnt/MegaProject/Dong_data/QRS_Classification_portal_data/eval_data/BeatComplexCalipers/'
    # curr_dir = os.getcwd()
    # physionet_directory = '/media/{}/MegaProject/PhysionetData/'.format(getpass.getuser())
    beat_model_path = "/mnt/Dataset/ECG/PortalData_2/QRS_Classification_portal_data/240520/128_05_40_0_0_0_5_0_0.99_c87/"
    model_name = "beat_concat_seq_add_more2_128Hz_3_8.16.32_0_0.5"

    # beat_checkpoint = glob(beat_model_path + f"/*/*/*/best_squared_error_metric/{model_name}*.h5")[0]
    beat_checkpoint = beat_model_path + f"/*/*/*/best_squared_error_metric/"
    beat_datastore_file = beat_model_path + '/datastore.txt'

    output_directory = DB_PATH + f'/result_{model_name}'
    if not os.path.isdir(output_directory):
        os.makedirs(output_directory)

    run_portal(use_gpu_index=0,
