...
def train():
    ...
    MEDIA_PATH = '/mnt/MegaProject/Dong_data/QRS_Classification_portal_data/{}_NSV/'.format('240623')
    ...
    for batch_size, pt in zip(BATCH_SIZE_TRAINING, DATA):
        ...
        # while count < 4:
            ...
            shutil.copytree('/mnt/MegaProject/Dong_data/QRS_Classification_portal_data/240529_NSV/128_05_40_0_0_0_6_0_0.99_c1/',
                            data_model_dir,
                            copy_function=shutil.copy2,
                            dirs_exist_ok=True)
            data_model.create_tfrecord_from_portal_event2_retrain(data_model_dir=data_model_dir,
            ...
            for i, model_name in enumerate(MODEL):
                ...
                # region training
                process_train = multiprocessing.Process(target=retrain_freeze_beat_classification,
                                                        args=(0,
                                                              model_name,
                                                              log_dir,
                                                              model_dir,
                                                              ...
                                                              2,
                                                              MAX_EPOCH,
                                                              '/mnt/MegaProject/Dong_data/QRS_Classification_portal_data/240529_NSV/128_05_40_0_0_0_6_0_0.99_c1/output/model/beat_concat_seq_add_more2_128Hz_3_8.16.32_0_0.5_1/best_squared_error_metric/')
                                                        )
                process_train.start()
                process_train.join()
                # endregion training
